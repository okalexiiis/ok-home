...
export default async function Thoughts() {
  ...
  return (
    <div className="flex flex-col flex-1 items-center gap-8 md:w-[60%] pt-16 px-4 md:px-0 selection:bg-purple selection:text-background">
      <header className="w-full border-b-4 border-purple flex items-center justify-between pb-2">
        <h1 className="font-mono text-2xl md:text-4xl text-purple font-bold">thoughts</h1>
