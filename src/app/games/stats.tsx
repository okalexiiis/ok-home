...
function StatCard({ value, label, index }: StatCardProps) {
  return (
    ...
    >
      <div className="pointer-events-none absolute -top-8 -right-8 w-24 h-24 rounded-full bg-orange opacity-0 blur-[40px] transition-opacity duration-500 group-hover:opacity-40" />
